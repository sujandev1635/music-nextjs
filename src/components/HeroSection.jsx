    ...
    return (
        <div className='h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0 text-white'>
            ...
            <div className="p-4 relative z-10 w-full text-center">
                ...
                <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem facere itaque voluptatem vel obcaecati sed impedit nemo repellat doloribus, debitis molestias quisquam labore unde voluptatibus explicabo sapiente qui repudiandae maiores!
                    Tempora doloribus earum nisi necessitatibus
                    Ipsa, perferendis</p>
                <div className="mt-4">
                    <Link href={'/course'}>
                        <Button
